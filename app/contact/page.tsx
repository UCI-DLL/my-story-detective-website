...
export default function ContactPage() {
  return <main className="contact-page">
    <SiteHeader />
    <section className="contact-hero"><p className="eyebrow">CONTACT US</p><div><h1>Start a conversation.</h1><p>Connect with the My Story Detective team for general inquiries or to explore how the project can fit your teachers, students, and existing literacy schedule.</p></div></section>
