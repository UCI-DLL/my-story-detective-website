...
export default function ResearchPage() {
  return <main className="research-page">
    ...
    <section className="research-hero-detail">
      ...
      <div><h1>Research that guides every story.</h1><p>Building on UCI research in early literacy and AI-supported dialogic learning, My Story Detective brings together Professor Young-Suk Kim’s foundational early-literacy research and the UCI Digital Learning Lab’s work with conversational agents. The project’s planned research will examine how these foundations can support children’s language, comprehension, and word reading.</p></div>
      <aside><span>RESEARCH FOUNDATIONS</span><strong>Built on two research foundations.</strong><p><a className="research-framework-link" href="#early-literacy-research">Professor Young-Suk Kim’s Early Literacy Research</a> and <a className="research-framework-link" href="#converse-to-learn-dialogic-reading-research">Converse to Learn Dialogic Reading Research</a> inform the project’s planned work to support children’s language, comprehension, and word reading.</p></aside>
    </section>
    ...
    <section className="research-foundations" id="early-literacy-research" aria-labelledby="kim-heading">
      <div className="research-section-heading"><p className="section-kicker">PROFESSOR YOUNG-SUK KIM’S EARLY LITERACY RESEARCH</p><h2 id="kim-heading">A foundation for language and literacy development.</h2><p>Professor Young-Suk Kim’s research connects the language, knowledge, and word-reading skills that children draw on as they become readers.</p></div>
      <p className="research-overview-label">RESEARCH OVERVIEW</p><div className="research-foundation-grid">
      ...
      </div><div className="research-inline-publications"><p className="research-publications-label">SELECTED PUBLICATIONS</p><div className="reference-list">
        ...
        <p>Kim, Y.-S. G. (2023). <a href="https://www.guilford.com/books/Handbook-on-the-Science-of-Early-Literacy/Cabell-Neuman-Patton-Terry/9781462551545" target="_blank" rel="noreferrer">Simplicity meets complexity: Expanding the Simple View of Reading with the Direct and Indirect Effects Model of Reading.</a> In S. Q. Cabell, S. B. Neuman, &amp; N. Patton Terry (Eds.), <em>Handbook on the science of early literacy</em> (pp. 9–22). Guilford Press.</p>
        <p>Kim, Y.-S. G., &amp; Leachman, M. (2026). <a href="https://www.guilford.com/books/Language-and-Literacy-Beyond-Decoding/Silverman-Keane/9781462559596/contents" target="_blank" rel="noreferrer">From ears to eyes: Supporting reading comprehension through systematic instruction on listening comprehension.</a> In R. D. Silverman &amp; K. Keane (Eds.), <em>Language and Literacy Beyond Decoding: Evidence-Based Instruction in Grades PreK–6</em> (pp. 73–92). Guilford Press.</p>
      </div></div>
    </section>

    <section className="research-lineage-detail" id="converse-to-learn-dialogic-reading-research">
      <div><p className="section-kicker">CONVERSE TO LEARN DIALOGIC READING RESEARCH</p><h2>Dialogic reading with conversational agents.</h2><p>The UCI Digital Learning Lab’s Converse to Learn research explores how conversational agents can support children’s learning with stories, video, and shared reading. This research informs My Story Detective’s dialogue-based reading experience.</p></div>
      <div className="research-lineage-card-area"><p className="research-overview-label">RESEARCH OVERVIEW</p><div className="research-lineage-cards">
        ...
        <p>Xu, Y., Aubele, J., Vigil, V., Bustamante, A. S., Kim, Y.-S., &amp; Warschauer, M. (2022). <a href="https://doi.org/10.1111/cdev.13708" target="_blank" rel="noreferrer">Dialogue with a conversational agent promotes children’s story comprehension via enhancing engagement.</a> <em>Child Development, 93</em>(2), e149–e167.</p>
        <p>Xu, Y., Wang, D., Collins, P., Lee, H., &amp; Warschauer, M. (2021). <a href="https://doi.org/10.1016/j.compedu.2020.104059" target="_blank" rel="noreferrer">Same benefits, different communication patterns: Comparing children’s reading with a conversational agent vs. a human partner.</a> <em>Computers &amp; Education, 161</em>, Article 104059.</p>
        <p>He, K., Cervera, K., Levine, J., Xu, Y., Collins, P., &amp; Warschauer, M. (2025). <a href="https://doi.org/10.1016/j.ijhcs.2025.103489" target="_blank" rel="noreferrer">Promoting parent-child shared reading with a bilingual conversational agent.</a> <em>International Journal of Human-Computer Studies, 199</em>, Article 103489.</p>
